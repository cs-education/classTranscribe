            ...
            React.createElement("form", null, 
                React.createElement("div", {className: "row"}, 
                    ...
                    React.createElement("div", {className: "six columns"}, 
                        ...
                        React.createElement("input", {className: "u-full-width", type: "text", defaultValue: this.props.className, id: "classInput"})
                    )
                ), 
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {className: "six columns"}, 
                ...
                React.createElement("input", {className: "button-primary", type: "submit", value: "Submit", on: true})
            )
        )
    }
});
