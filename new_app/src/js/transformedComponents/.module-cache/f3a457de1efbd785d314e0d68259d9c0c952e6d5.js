...
require(['jquery.js', 'react.js'], function (jquery, React) {
    //var $ = require('jquery');
    var $ = jquery;
        ...
        render: function () {
            return (
                React.createElement("form", {className: "u-cf"}, 
                    ...
                    React.createElement("button", {className: "registrationSubmit button-primary", type: "submit", onClick: this.handleSubmit}, "Submit")
                )
            )
        }
    });
