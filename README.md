...
2. sudo docker run  -i -t -p 80:8000 -e "REDIS_PASS=<REDACTED>" -e "REDIS_HOST=<REDACTED>" -e "MAILER_ID=<REDACTED>" -e "MAILER_PASS=<REDACTED>" classtranscribe /bin/bash -"npm install; node server.js"
